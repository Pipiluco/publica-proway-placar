...
/**
 * Classe de {@link Service} referente a {@link Game}
 */
@Service
public class GameService {
	...
	public int findMinPoints(Long id) {
		return gameRepository.findMinPoints(id);
	}

	public int findMaxPoints(Long id) {
		return gameRepository.findMaxPoints(id);
	}
